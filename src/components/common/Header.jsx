...
const Header = () => {
    ...
    return (
        <motion.header
            className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 backdrop-blur-md ${isScrolled ? (theme === 'dark' ? 'bg-gray-900/70 shadow-md' : 'bg-base-100/60 shadow-md') : (theme === 'dark' ? 'bg-gray-900/40' : 'bg-white/30')} ${showNavbar ? 'translate-y-0' : '-translate-y-full'}`}
            ...
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    ...
                    <Link to="/" className="flex items-center space-x-2">
                        ...
                        <div className="font-bold text-xl tracking-tight text-base-content">
                            LeetCode Patterns
                        </div>
                    </Link>
                    {/* Desktop Navigation */}
                    <nav className="hidden md:flex items-center space-x-8">
                        ...
                        <motion.button
                            onClick={toggleTheme}
                            className="p-2 rounded-full hover:bg-base-200 transition relative flex items-center justify-center border border-base-200"
                        ...
                        >
                            {/* Show moon icon in light mode, sun icon in dark mode (opposite of current mode) */}
                            {theme === 'light' ? (
