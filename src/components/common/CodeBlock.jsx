...
const CodeBlock = ({ code, language = 'javascript', title }) => {
    ...
    return (
        <motion.div
            className="my-6 rounded-lg overflow-hidden shadow-lg bg-dark-200 border border-gray-700"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.3 }}
        >
            {/* Header with title and copy button */}
            <div className="flex justify-between items-center px-4 py-2 bg-dark-300 border-b border-gray-700">
            ...
            <div className="overflow-x-auto">
                <div className="p-4 font-mono text-sm flex">
                    ...
                    <pre className="pl-4 overflow-x-auto">
